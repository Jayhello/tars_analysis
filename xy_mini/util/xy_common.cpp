...
string TC_Common::ms2str(int64_t ms) {
    ...
    size_t n = snprintf(&s[0], s.size(), szFormat, tt.tm_year + 1900, tt.tm_mon + 1, tt.tm_mday, tt.tm_hour,
                        tt.tm_min, tt.tm_sec, duration_in_ms);
    s.resize(n);
...
//参照phorix的优化
static char c_b2s[256][4] = {"00", "01", "02", "03", "04", "05", "06", "07", "08", "09", "0a", "0b", "0c", "0d",
                             ...
                             "bd", "be", "bf", "c0", "c1", "c2", "c3", "c4", "c5", "c6", "c7", "c8", "c9", "ca",
...
int TC_Common::getMatchPeriodDays(const std::vector<int> &days, const std::pair<string, int> &period,
