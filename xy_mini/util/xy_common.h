...
public:
    ...
    */
    ...
    static bool
    equal(const unordered_set<double> &vx, const unordered_set<double> &vy, double epsilon = _EPSILON_DOUBLE);

    static bool equal(const unordered_set<double> &vx, const unordered_set<double> &vy, float epsilon);

    static bool
    equal(const unordered_set<float> &vx, const unordered_set<float> &vy, float epsilon = _EPSILON_FLOAT);
    ...
    */
    ...
    template<typename K, typename V, typename D, typename A, typename E=double>
    static bool
    equal(const unordered_map <K, V, D, A> &mx, const unordered_map <K, V, D, A> &my, E epsilon = _EPSILON_DOUBLE);
